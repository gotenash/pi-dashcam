...
echo ""
echo "=== 2. Activation de l'interface I2C (pour UPS-Lite) ==="
if command -v raspi-config >/dev/null 2>&1; then
    raspi-config nonint do_i2c 0
    echo "Interface I2C activée via raspi-config."
fi
...
# Chargement du module noyau i2c-dev
...
systemctl enable dashcam-web.service
...
echo "  - Voir l'adresse I2C (0x36)   : i2cdetect -y 1"
...
echo ""
echo "NOTE : Si l'I2C vient d'être activé pour la première fois, un redémarrage"
echo "peut être nécessaire : sudo reboot"